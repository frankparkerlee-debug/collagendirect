<?php
/**
 * My Wholesale Orders - Physician view of their wholesale/office stock orders
 * Allows physicians to view and cancel their wholesale orders before admin processes them
 */

// This file is included by portal/index.php, so $cu (current user) is available
global $pdo, $cu;
...
// Fetch wholesale orders for this physician
$stmt = $pdo->prepare("
  SELECT
    o.id,
    o.created_at,
...
<div style="max-width: 1400px; margin: 0 auto; padding: 2rem;">
  ...
  <div style="margin-bottom: 2rem;">
    ...
    <p style="color: #64748b;">
      View and manage your office stock and wholesale orders
    </p>
  </div>
    ...
    <div style="overflow-x: auto;">
      <table style="width: 100%; border-collapse: collapse;">
        <thead style="background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
          <tr>
            <th style="padding: 0.75rem 1rem; text-align: left; font-size: 0.75rem; font-weight: 600; color: #64748b; text-transform: uppercase;">Order Date</th>
        ...
        <tbody>
          ...
          <tr>
            <td colspan="8" style="padding: 3rem; text-align: center; color: #94a3b8;">
              ...
              <div style="font-size: 0.875rem;">
                <a href="?page=wholesale-order" style="color: #3b82f6; text-decoration: underline;">Create your first wholesale order</a>
              </div>
            </td>
          </tr>
          <?php else: ?>
          ...
          <tr style="border-bottom: 1px solid #e2e8f0;">
            ...
            <td style="padding: 1rem; text-align: right; font-size: 0.875rem; font-weight: 600; color: #1e293b;">
              ...
              <div style="font-size: 0.75rem; color: #94a3b8; font-weight: normal;">$<?= number_format($unit_price, 2) ?>/pc</div>
            </td>
            <td style="padding: 1rem; font-size: 0.875rem;">
            ...
            <td style="padding: 1rem; text-align: right;">
              <?php if ($canCancel): ?>
                <form method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to cancel this order? This action cannot be undone.');">
                  ...
                  <button type="submit" style="padding: 0.5rem 1rem; background: white; color: #ef4444; border: 1px solid #ef4444; border-radius: 0.375rem; font-size: 0.875rem; font-weight: 500; cursor: pointer; transition: all 0.2s;">
                    Cancel Order
                  </button>
                </form>
              <?php else: ?>
  ...
  <div style="margin-top: 2rem; padding: 1.5rem; background: #f8fafc; border-radius: 0.5rem; border-left: 4px solid #3b82f6;">
    ...
    <ul style="margin: 0; padding-left: 1.5rem; color: #64748b; font-size: 0.875rem; line-height: 1.6;">
      ...
      <li>For questions about pricing or order status, contact support</li>
    </ul>
  </div>
</div>
