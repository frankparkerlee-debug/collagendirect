...
<style>
  :root{--brand:#11b5a5; --ink:#0f172a; --muted:#64748b; --ring:rgba(17,181,165,.25); --line:#e2e8f0}
  html,body{font-family:Inter,system-ui,-apple-system,Segoe UI,Roboto,"Helvetica Neue",Arial,sans-serif;color:var(--ink)}
  .card{background:#fff;border:1px solid var(--line);border-radius:16px;box-shadow:0 1px 1px rgba(0,0,0,.02),0 2px 8px rgba(0,0,0,.02)}
  .btn{display:inline-flex;align-items:center;gap:.5rem;border:1px solid var(--line);border-radius:12px;padding:.55rem .9rem;background:#fff;transition:box-shadow .15s}
  .btn:focus{outline:none;box-shadow:0 0 0 3px var(--ring)}
  .btn-primary{background:var(--brand);color:#022c22;border-color:transparent}
  ...
  input,select,textarea{border:1px solid var(--line);border-radius:.65rem;padding:.55rem .75rem}
  dialog::backdrop{background:rgba(15,23,42,.5)}
  .sidenav a{display:flex;gap:.6rem;align-items:center;padding:.6rem .8rem;border-radius:.75rem;color:#1f2937}
  .sidenav a.active{background:#eefaf8;color:#0b5f56;border:1px solid #cfeeea}
</style>
</head>
