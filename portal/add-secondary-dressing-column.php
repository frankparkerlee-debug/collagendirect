...
// Run once via web browser: https://collagendirect.onrender.com/portal/add-secondary-dressing-column.php?key=change-me-in-production
...
echo "Adding secondary_dressing column to orders table...\n\n";
...
try {
    ...
    // Add column
    $pdo->exec("ALTER TABLE orders ADD COLUMN IF NOT EXISTS secondary_dressing VARCHAR(255)");
    echo "✓ Added secondary_dressing column\n\n";

    // Verify
    $result = $pdo->query("
        SELECT column_name, data_type, character_maximum_length
        FROM information_schema.columns
        WHERE table_name = 'orders' AND column_name = 'secondary_dressing'
