...
if (!$authorized) {
    ...
    <head>
        ...
        <title>Access Restricted - Sales Training Portal</title>
    ...
    <body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen flex items-center justify-center">
        <div class="bg-white rounded-3xl shadow-2xl p-12 max-w-md text-center">
            ...
            <p class="text-gray-600 mb-8">
                This portal is only accessible to CollagenDirect team members with a <strong>@collagendirect.health</strong> email address.
            </p>
    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          ...
          <a href="/login" class="text-sm text-gray-500 hover:text-brand-teal transition">Logout</a>
        </div>
      </div>
    </div>
  </header>
