...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-6 py-4">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          ...
          <span class="text-purple-200 text-sm">Physician Portal Guide</span>
        </div>
        <a href="/portal/index.php" class="bg-white text-purple-700 px-6 py-2 rounded-lg font-semibold hover:bg-purple-50 transition">
          Launch Portal →
        </a>
      </div>
    </div>
  ...
  <section class="gradient-bg text-white py-20">
    <div class="container mx-auto px-6 text-center">
      <h1 class="text-5xl font-bold mb-6">Physician Portal Guide</h1>
      <p class="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
        Everything you need to know about ordering wound care supplies for your patients
      </p>
      <div class="flex gap-4 justify-center">
        <a href="#getting-started" class="bg-white text-purple-700 px-8 py-3 rounded-lg font-semibold hover:bg-purple-50 transition">
          Get Started
        </a>
        <a href="#features" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-purple-700 transition">
          Features
        </a>
      </div>
    </div>
  ...
  <nav class="bg-white border-b sticky top-16 z-40 shadow-sm">
    <div class="container mx-auto px-6">
      <div class="flex gap-8 overflow-x-auto py-4 text-sm font-medium">
        <a href="#getting-started" class="text-gray-700 hover:text-purple-600 whitespace-nowrap">Getting Started</a>
        <a href="#dashboard" class="text-gray-700 hover:text-purple-600 whitespace-nowrap">Dashboard</a>
        <a href="#patients" class="text-gray-700 hover:text-purple-600 whitespace-nowrap">Patient Management</a>
        <a href="#orders" class="text-gray-700 hover:text-purple-600 whitespace-nowrap">Creating Orders</a>
        <a href="#icd10" class="text-gray-700 hover:text-purple-600 whitespace-nowrap">ICD-10 Search</a>
        <a href="#documents" class="text-gray-700 hover:text-purple-600 whitespace-nowrap">Documents</a>
        <a href="#tips" class="text-gray-700 hover:text-purple-600 whitespace-nowrap">Tips & Tricks</a>
      </div>
    </div>
  </nav>
  ...
  <div class="container mx-auto px-6 py-12">
    ...
    <section id="getting-started" class="section mb-20">
      ...
      <div class="grid md:grid-cols-3 gap-6 mb-12">
        <div class="feature-card bg-white p-6 rounded-xl shadow-md">
          ...
          <p class="text-gray-600">Access the portal at <a href="https://collagendirect.health/portal" class="text-purple-600 hover:underline">collagendirect.health/portal</a> with your credentials</p>
        </div>
      ...
      <div class="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
        <h4 class="font-bold text-blue-900 mb-2">First Time Login?</h4>
        <p class="text-blue-800">If you don't have login credentials yet, contact CollagenDirect support to create your account. You'll receive a welcome email with your temporary password.</p>
      </div>
    </section>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
        ...
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div class="space-y-3">
              <button class="w-full bg-purple-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-purple-700 transition text-left flex items-center justify-between">
                <span>New Order</span>
                <span>→</span>
              </button>
              <button class="w-full bg-white border-2 border-gray-300 py-3 px-4 rounded-lg font-semibold hover:border-purple-600 transition text-left flex items-center justify-between">
            ...
            <div class="flex-1">
              ...
              <div class="grid md:grid-cols-3 gap-4 mt-2">
                ...
                <div class="bg-purple-50 border border-purple-200 p-3 rounded-lg text-sm">
                  <strong class="text-purple-900">Clinical Notes</strong>
                  <p class="text-purple-700 text-xs mt-1">Visit notes or assessments</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm">
              <li class="flex items-center gap-2">
                <span class="text-purple-600">✓</span> Date of Birth
              </li>
              <li class="flex items-center gap-2">
                <span class="text-purple-600">✓</span> Contact Information (Phone, Email)
              </li>
              <li class="flex items-center gap-2">
                <span class="text-purple-600">✓</span> Address
              </li>
              <li class="flex items-center gap-2">
                <span class="text-purple-600">✓</span> Insurance Details
              </li>
              <li class="flex items-center gap-2">
                <span class="text-purple-600">✓</span> Upload New Documents
              </li>
            </ul>
          </div>
            ...
            <div class="bg-gray-50 p-4 rounded-lg mt-2">
              ...
              <div class="grid md:grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <p class="text-purple-600 text-xs">✨ NEW: Autocomplete search!</p>
                </div>
                <div>
    ...
    <section id="icd10" class="section mb-20">
      <h2 class="text-4xl font-bold mb-8">ICD-10 Code Search ✨ NEW</h2>

      <div class="bg-gradient-to-r from-purple-50 to-blue-50 border-2 border-purple-200 rounded-xl p-8 mb-8">
      ...
      <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <div class="grid md:grid-cols-2 gap-4">
          <div class="border border-gray-200 rounded-lg p-4">
            <h4 class="font-bold mb-2 text-purple-700">Pressure Ulcers</h4>
          ...
          <div class="border border-gray-200 rounded-lg p-4">
            <h4 class="font-bold mb-2 text-purple-700">Diabetic Ulcers</h4>
            <ul class="space-y-1 text-sm text-gray-700">
          ...
          <div class="border border-gray-200 rounded-lg p-4">
            <h4 class="font-bold mb-2 text-purple-700">Venous Ulcers</h4>
            <ul class="space-y-1 text-sm text-gray-700">
          ...
          <div class="border border-gray-200 rounded-lg p-4">
            <h4 class="font-bold mb-2 text-purple-700">Surgical Wounds</h4>
            <ul class="space-y-1 text-sm text-gray-700">
    ...
    <section id="documents" class="section mb-20">
      ...
      <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-start gap-4">
            <span class="text-purple-600 text-2xl">4.</span>
            <div>
    ...
    <section id="tips" class="section mb-20">
      ...
      <div class="mt-8 bg-gradient-to-r from-purple-50 to-blue-50 border-2 border-purple-200 rounded-xl p-8">
        <h3 class="text-2xl font-bold mb-4 text-purple-900">Best Practices</h3>
        <div class="grid md:grid-cols-2 gap-6">
          <div>
    ...
    <!-- Need Help -->
    <section class="mb-20">
      <div class="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-2xl shadow-xl p-12 text-center">
        ...
        <div class="flex flex-wrap gap-4 justify-center">
          <a href="mailto:support@collagendirect.health" class="bg-white text-purple-700 px-8 py-4 rounded-lg font-semibold hover:bg-purple-50 transition flex items-center gap-2">
            <span>📧</span>
            Email Support
          </a>
          <a href="tel:+18884156880" class="bg-purple-700 border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-purple-800 transition flex items-center gap-2">
            <span>📞</span>
            Call (888) 415-6880
          </a>
          <a href="/portal/index.php" class="bg-purple-700 border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-purple-800 transition flex items-center gap-2">
            <span>🚀</span>
            Launch Portal
          </a>
        </div>
