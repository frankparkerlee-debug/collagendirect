...
<div class="app-container">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <!-- Onboard Clinic -->
      <a class="<?=isActive('onboard-clinic')?>" href="/admin/employee-rep/onboard-clinic.php">
        <svg class="sidebar-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
        <span>Onboard Clinic</span>
      </a>

      <!-- Add Physician -->
      <a class="<?=isActive('add-physician')?>" href="/admin/employee-rep/add-physician.php">
