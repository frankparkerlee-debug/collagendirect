<?php
/**
 * Migration: Add Billing Routing System
 *
 * Adds support for insurance-based billing routing for hybrid DME practices
 * - practice_billing_routes table for insurer routing configuration
 * - practice_account_transactions table for wholesale balance tracking
 * - billed_by column to orders table
 * - default_billing_route column to users table
 */
