...
<div class="app-container">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <!-- HealKit Section -->
      <a class="<?=isActive('healkit-orders')?>" href="/admin/healkit-orders.php">
      ...
      <div class="nav-group">
        <a class="nav-parent <?php echo (isActive('users') || isActive('practices') || isActive('internal-users') || isActive('distributors') || isActive('roles-permissions') || isActive('db-search')) ? 'active expanded' : ''; ?>" href="#" onclick="toggleSubmenu(event, 'settings-submenu')">
        ...
        <div id="settings-submenu" class="nav-submenu" style="display: <?php echo (isActive('users') || isActive('practices') || isActive('internal-users') || isActive('distributors') || isActive('roles-permissions') || isActive('db-search')) ? 'flex' : 'none'; ?>;">
