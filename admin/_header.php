...
<div class="app-container">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-group">
        <a class="nav-parent <?php echo (isActive('users') || isActive('practices') || isActive('internal-users') || isActive('distributors') || isActive('demo-users') || isActive('roles-permissions') || isActive('db-search')) ? 'active expanded' : ''; ?>" href="#" onclick="toggleSubmenu(event, 'settings-submenu')">
        ...
        <div id="settings-submenu" class="nav-submenu" style="display: <?php echo (isActive('users') || isActive('practices') || isActive('internal-users') || isActive('distributors') || isActive('demo-users') || isActive('roles-permissions') || isActive('db-search')) ? 'flex' : 'none'; ?>;">
          ...
          <?php endif; ?>
          <?php if (in_array($admin['role'] ?? '', ['superadmin', 'admin', 'sales'])): ?>
          <a class="<?=isActive('demo-users')?>" href="/admin/demo-users.php">
            <span>Demo Portal Users</span>
          </a>
          <?php endif; ?>
          <?php if (in_array($admin['role'] ?? '', ['superadmin', 'admin'])): ?>
          ...
          <?php endif; ?>
          <?php if (in_array($admin['role'] ?? '', ['superadmin'])): ?>
          <a class="<?=isActive('db-search')?>" href="/admin/platform/db-search.php">
            <span>DB Search</span>
          </a>
          <?php endif; ?>
