<?php
/**
 * Sales Rep: Create Wholesale Order
 *
...
<!-- Page Header -->
<div class="mb-6">
  <a href="/admin/rep/wholesale-orders.php" class="text-brand hover:underline text-sm">&larr; Back to Wholesale Orders</a>
...
<?php if (empty($clinics)): ?>
  <div class="card p-8 text-center">
    ...
    <a href="/admin/rep/onboard-clinic.php" class="btn btn-primary">Onboard a Wholesale Clinic</a>
  </div>
<?php else: ?>
  <div class="card p-6">
