<?php
/**
 * Database Migration: Add Physician Fields to Orders Table
 * Adds fields to store selected physician's NPI, License, and ID for multi-physician practices
 * Created: 2025-11-22
 */
...
try {
  ...
  echo "\n✅ Migration complete!\n";
  echo "\nThese columns will be populated when practice admins select a physician from their roster.\n";
